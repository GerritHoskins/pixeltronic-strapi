...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description: Attribute.String & Attribute.Required & Attribute.DefaultTo<'description text'>;
    image: Attribute.Media;
    url: Attribute.String & Attribute.DefaultTo<'https://pixeltronic.dev'>;
    link: Attribute.String & Attribute.DefaultTo<'https://pixeltronic.dev'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
